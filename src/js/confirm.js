...
function upDate() {
  ...
  document.getElementById("adress1-2").disabled = true;
  document.getElementById("adress2-2").disabled = true;
  document.getElementById("allergie1").disabled = true;
  document.getElementById("allergie2").disabled = true;
  document.getElementById("txt-area2").disabled = true;
  document.getElementById("txt-area2-2").disabled = true;
}
