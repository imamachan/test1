...
function mouseMove() {
  ...
  } else if (lastNameLength.length > 10) {
    errMsgName.textContent = "※10文字以下で入力してください";
  } else {
...
function mouseMoveFirstName() {
  ...
  } else if (firstNameLength.length > 10) {
    errMsgName.textContent = "※10文字以下で入力してください";
  } else {
    errMsgName.textContent = "";
  }
...
function pageChange() {
  ...
  const elements = document.getElementsByName("gender2");
